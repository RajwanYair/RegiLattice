...
> Last verified: 2026-03-30 (v5.98.0, ~9,190 tweaks, 135 categories, 2,934 tests).
...
| Test     | xUnit 2.9.3 — 2,934 tests (0 failures)                                   |
| GUI      | WinForms with 11 themes (Catppuccin Mocha/Latte, Nord, Dracula + 7 more) |
| Version  | 5.98.0                                                                   |
| Install  | `dotnet build RegiLattice.sln -c Release`                                |
| Tweaks   | 9,190 across 135 categories (130 module files)                           |
| Tests    | 2934 passing (0 consistent failures)                                     |
...
Key namespaces: `RegiLattice.Core` (engine + models + registry + 135-category tweak modules), `RegiLattice.GUI` (WinForms, 11 themes), `RegiLattice.CLI` (25+ commands). Tests live in `tests/` — 3 projects, 2934 total.
...
Projects: `RegiLattice.Core.Tests` (2293 tests), `RegiLattice.CLI.Tests` (301 tests), `RegiLattice.GUI.Tests` (340 tests). Total: 2934.
