...
> Last verified: 2026-05-14 (v6.35.0, ~7,718 tweaks, 158 categories, 3,373 tests).
...
| Test     | xUnit 2.9.3 — 3,373 tests (0 failures)                                   |
...
| Tests    | 3,373 passing (0 consistent failures)                                    |
| NuGet    | System.Management 10.0.12, Microsoft.NET.Test.Sdk 17.14.1               |
...
Key namespaces: `RegiLattice.Core` (engine + models + registry + tweak modules, 31 files), `RegiLattice.GUI` (WinForms, 11 themes), `RegiLattice.CLI` (25+ commands). Tests live in `tests/` — 3 projects, 3,373 total.
...
Projects: `RegiLattice.Core.Tests` (2,570 tests), `RegiLattice.CLI.Tests` (440 tests), `RegiLattice.GUI.Tests` (363 tests). Total: 3,373.
