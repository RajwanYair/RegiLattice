...
Version 6.35.0 — C# 13 / .NET 10.0-windows, migrated from Python v1.x.
...
- **Testing**: xUnit 2.9.3 + coverlet 8.0.1
...
│   │   └── Tweaks/              # 195 module files (31 original + 164 extracted/split), 7,718 tweaks across 158 categories
