...
internal static class Firewall
{
    ...
    [
        ...
        new TweakDef
        {
            Id = "fw-enable-private-profile-logging",
            Label = "Enable Private Profile Firewall Logging",
            Category = "Firewall",
            NeedsAdmin = true,
            CorpSafe = true,
        ...
        new TweakDef
        {
            Id = "fw-enable-domain-outbound-block",
            Label = "Default-Block Outbound on Domain Profile",
            Category = "Firewall",
            NeedsAdmin = true,
            CorpSafe = false,
