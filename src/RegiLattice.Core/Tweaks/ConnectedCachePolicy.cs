...
internal static class ConnectedCachePolicy
{
    ...
    [
        new TweakDef
        {
            ...
            Description = "Prevents Windows from acting as a client to Microsoft Connected Cache (MCC) servers. The device will not retrieve Windows Update, Delivery Optimization, or Microsoft 365 content from local MCC nodes.",
            ...
            ImpactScore = 3,
            SafetyRating = 5,
            ImpactNote = "Devices will download update content directly from Microsoft CDN instead of from an on-premises MCC node; may increase internet bandwidth consumption.",
            RegistryKeys = [MccKey],
        ...
        new TweakDef
        {
            ...
            Category = "Microsoft Connected Cache Policy",
            Description = "Configures Windows to only retrieve cached content from administrator-specified Microsoft Connected Cache nodes, preventing download from unapproved or public MCC servers.",
            ...
            ImpactScore = 3,
            SafetyRating = 5,
            ImpactNote = "Ensures update traffic goes through the organisation's approved cache infrastructure, supporting network segmentation and compliance.",
            RegistryKeys = [MccKey],
        ...
        new TweakDef
        {
            ...
            Category = "Microsoft Connected Cache Policy",
            Description = "Specifies the FQDN or IP address of the Microsoft Connected Cache node that this device should use as its primary cache source for Windows Update and Delivery Optimization content.",
        ...
        new TweakDef
        {
            ...
            Category = "Microsoft Connected Cache Policy",
            Description = "Sets the Delivery Optimization download mode to HTTP-only (mode 0), preventing Windows from using peer-to-peer transfers between devices on the local network or internet. Content is sourced from Microsoft CDN or MCC only.",
            ...
            ImpactScore = 3,
            SafetyRating = 5,
            ImpactNote = "Prevents devices from sharing update packages with each other; reduces lateral data movement and ensures organisational control over update source.",
        ...
        new TweakDef
        {
            ...
            Category = "Microsoft Connected Cache Policy",
            Description = "Caps background Delivery Optimization download transfers at 50% of the measured internet bandwidth, preventing bulk update downloads from saturating the connection during working hours.",
            ...
            ImpactScore = 3,
            SafetyRating = 5,
            ImpactNote = "Keeps 50% of bandwidth available for interactive use while background updates download. Adjust the value to match your SLA.",
            RegistryKeys = [DeliveryOptKey],
        ...
        new TweakDef
        {
            ...
            Category = "Microsoft Connected Cache Policy",
            Description = "Caps foreground Delivery Optimization download transfers at 80% of the measured bandwidth, allowing user-initiated downloads like Microsoft Store apps or Windows Updates to proceed quickly without total saturation.",
            Tags = ["mcc", "delivery-optimization", "bandwidth", "throttle", "performance"],
            NeedsAdmin = true,
            CorpSafe = true,
            MinBuild = 19041,
        ...
        new TweakDef
        {
            ...
            Category = "Microsoft Connected Cache Policy",
            Description = "Sets the maximum disk space available to the Microsoft Connected Cache client for storing downloaded content packages. Prevents the cache from consuming unpredictable amounts of the system drive.",
        ...
        new TweakDef
        {
            ...
            Category = "Microsoft Connected Cache Policy",
            Description = "Prevents the device from uploading locally cached Delivery Optimization content to other clients on the LAN or internet, configuring the node as a download-only client.",
            ...
            ImpactScore = 3,
            SafetyRating = 5,
            ImpactNote = "Ensures devices only consume bandwidth for their own downloads, not to serve other clients. Useful for metered-connection endpoints.",
            RegistryKeys = [DeliveryOptKey],
        ...
        new TweakDef
        {
            ...
            Category = "Microsoft Connected Cache Policy",
            Description = "Configures Delivery Optimization to allow peer-to-peer transfers only within the local area network (LAN), not over the internet. Prevents content sharing with devices outside the organisation's network boundary.",
        ...
        new TweakDef
        {
            ...
            Category = "Microsoft Connected Cache Policy",
            Description = "Prevents Delivery Optimization and Microsoft Connected Cache downloads from occurring when the network connection is detected as metered (e.g., mobile data). Downloads resume automatically on unmetered connections.",
            ...
            ImpactScore = 3,
            SafetyRating = 5,
            ImpactNote = "Prevents unexpected data charges on mobile hotspots, cellular-connected laptops, or any connection marked metered in Windows.",
            RegistryKeys = [MccClientKey],
