...
internal static class Hardening
{
    ...
    [
        new TweakDef
        {
            ...
            Tags = ["hardening", "security", "uac", "pass-the-hash", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            Tags = ["hardening", "security", "smb", "encryption", "cis-l2"],
        ...
        new TweakDef
        {
            ...
            Tags = ["hardening", "security", "smb", "wannacry", "cis-l1"],
            ApplyAction = _ =>
        ...
        new TweakDef
        {
            ...
            Tags = ["hardening", "security", "audit", "logon", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            Tags = ["hardening", "security", "firewall", "network", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            Tags = ["hardening", "cfg", "control-flow", "mitigation", "exploit", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            Tags = ["hardening", "ntlm", "kerberos", "credential-relay", "authentication", "cis-l2"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = false,
            Tags = ["hardening", "anonymous", "sam", "shares", "null-session", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "anonymous", "everyone", "group", "security", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "netlogon", "signing", "sealing", "domain", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "netlogon", "sealing", "encryption", "domain", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "netlogon", "signing", "domain", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "netlogon", "key", "domain", "security", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "password", "blank", "network", "security", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "admin", "owner", "object", "acl", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "logon", "unlock", "password", "security", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "rpc", "remote", "unauthenticated", "policy", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "password", "machine", "domain", "rotation", "cis-l1"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Tags = ["hardening", "ntlm", "audit", "traffic", "logging", "cis-l1"],
