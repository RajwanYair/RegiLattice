// RegiLattice.Core — Tweaks/CloudExperience.cs
// OOBE, cloud experience, and first-run settings (Sprint 93).
// Slug "oobe" — HKLM/HKCU cloud experience host, consumer features, OOBE.
// Distinct from Privacy.cs (general telemetry) and Widgets.cs (widget content).
