...
internal static class Services
{
    ...
    [
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the SSDP Discovery service. Stops Windows from broadcasting and responding to UPnP device discovery packets on the local network.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the UPnP Device Host service. Prevents this machine from acting as a discoverable UPnP host, reducing the attack surface on untrusted networks.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the fdPHost service. Stops Windows from using WS-Discovery and other protocols to automatically find networked printers and devices.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the FDResPub service. Prevents this machine from advertising itself on the local network via WS-Discovery, removing it from the Network neighbourhood of other PCs.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the SharedAccess (ICS) service. Removes Windows' built-in NAT router capability, preventing accidental or unauthorised sharing of the internet connection.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the RemoteAccess (RRAS) service. Stops Windows from acting as a software router/VPN server. Not needed on standard workstations.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the wisvc (Windows Insider Service). Prevents the device from being enrolled in Windows Insider preview flight deliveries and associated telemetry collection.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the autotimesvc (Cellular Time) service. This service syncs the system clock via mobile-broadband data — not needed on non-cellular or always-connected PCs.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the napagent (Network Access Protection Agent) service. NAP is deprecated since Windows Server 2012 R2 and the agent is unused on modern workstations.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the tzautoupdate service. Prevents Windows from automatically adjusting the system time zone based on location data. Useful for servers and VMs where the time zone should be fixed.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the diagnosticshub.standardcollector.service. This service collects real-time diagnostic events from ETW providers for Visual Studio profiling sessions — not needed outside of profiling.",
            ...
            RemoveOps = [RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\diagnosticshub.standardcollector.service", "Start", 3)],
            DetectOps = [RegOp.CheckDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\diagnosticshub.standardcollector.service", "Start", 4)],
        },
    ];
}
