...
internal static class Virtualization
{
    ...
    [
        new TweakDef
        {
            ...
            DetectOps = [RegOp.CheckDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization", "AllowEnhancedSessionMode", 0)],
        },
        new TweakDef
        {
            ...
            DetectOps = [RegOp.CheckDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management", "LargeSystemCache", 0)],
        },
        new TweakDef
        {
            Id = "virt-disable-vbs",
            ...
            NeedsAdmin = true,
            CorpSafe = false,
            Description = "Disables VBS which can reduce performance in games and creative apps. WARNING: Reduces security — only use on personal gaming/performance rigs.",
        ...
        new TweakDef
        {
            ...
            ApplyOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Sandbox", "AllowSandbox", 0),
            ],
            RemoveOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\Sandbox", "AllowSandbox", 1),
            ],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = false,
            Description = "Disables Hypervisor-enforced Code Integrity (HVCI / Memory Integrity). Can improve gaming performance by 5-10% but reduces security.",
            Tags = ["hvci", "virtualization", "performance", "gaming"],
            RegistryKeys = [@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\DeviceGuard"],
            ApplyOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\DeviceGuard", "Enabled", 0),
            ],
            RemoveOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\DeviceGuard", "Enabled", 1),
            ],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables automatic VM stop action on host shutdown. VMs will be saved to disk instead of stopped. Default: Disabled. Recommended: Enabled for server VMs.",
            Tags = ["hyperv", "virtualization", "auto-stop"],
            RegistryKeys = [@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\HyperV"],
            ApplyOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\HyperV", "DisableAutomaticStopAction", 1),
            ],
            RemoveOps =
            [
                RegOp.DeleteValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\HyperV", "DisableAutomaticStopAction"),
            ],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = false,
            Description = "Disables Microsoft Defender Application Guard (MDAG). Frees memory and CPU used by isolation containers for Edge browser. Default: Enabled. Recommended: Disabled if not needed.",
            Tags = ["virtualization", "appguard", "security", "performance"],
            RegistryKeys = [@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\AppHVSI"],
            ApplyOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\AppHVSI", "AllowAppHVSI_ProviderSet", 0),
            ],
            RemoveOps =
            [
                RegOp.DeleteValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\AppHVSI", "AllowAppHVSI_ProviderSet"),
            ],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Sets Hyper-V VM worker processes to high priority within the Windows scheduler. Reduces VM latency. Default: Normal priority. Recommended: High priority for dedicated VM hosts.",
            ...
            DetectOps = [RegOp.CheckDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization", "HighVmWorkerProcessPriority", 1)],
        },
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = false,
            Description = "Enables Hyper-V nested virtualization. Allows running hypervisors inside Hyper-V VMs. Default: disabled. Recommended: enable for dev/test workloads.",
            Tags = ["hyperv", "virtualization", "nested", "development"],
            RegistryKeys = [@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization"],
            ApplyOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization", "NestedVirtualization", 1),
            ],
            RemoveOps =
            [
                RegOp.DeleteValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization", "NestedVirtualization"),
            ],
            DetectOps = [RegOp.CheckDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization", "NestedVirtualization", 1)],
        },
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = false,
            Description = "Sets the Hyper-V Virtual Machine Management service to manual start. Reduces boot time and background resource usage when VMs are not in use. Default: Automatic (2). Recommended: Manual (3).",
            Tags = ["hyperv", "virtualization", "autostart", "service", "boot"],
            RegistryKeys = [@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\vmms"],
            ApplyOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\vmms", "Start", 3),
            ],
            RemoveOps =
            [
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = false,
            Description = "Enables nested virtualization via Hyper-V group policy. Allows hypervisors inside VMs at the policy level. Default: Not set. Recommended: Enabled for dev workloads.",
            Tags = ["hyperv", "virtualization", "nested", "policy"],
            RegistryKeys = [@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\HyperV"],
            ApplyOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\HyperV", "AllowNestedVirtualization", 1),
            ],
            RemoveOps =
            [
                RegOp.DeleteValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\HyperV", "AllowNestedVirtualization"),
            ],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = false,
            Description = "Enables Hyper-V Enhanced Session Mode for RDP-like VM experience with clipboard, audio, and drive sharing. Default: Disabled. Recommended: Enabled.",
            ...
            DetectOps = [RegOp.CheckDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization", "AllowEnhancedSessionMode", 1)],
        },
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = false,
            Description = "Enables the Virtual Machine Platform / Hypervisor Enforced Code Integrity. Required for WSL2 and Android subsystem. Default: Disabled. Recommended: Enabled if using VMs.",
            ...
            ApplyOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\DeviceGuard\Scenarios\HypervisorEnforcedCodeIntegrity", "Enabled", 1),
            ],
            RemoveOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\DeviceGuard\Scenarios\HypervisorEnforcedCodeIntegrity", "Enabled", 0),
            ],
            DetectOps = [RegOp.CheckDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\DeviceGuard\Scenarios\HypervisorEnforcedCodeIntegrity", "Enabled", 1)],
        },
        new TweakDef
        {
            Id = "virt-vds-manual",
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Sets the Virtual Disk Service (VDS) to manual start, reducing boot time overhead on systems not using disk management tools. Default: Automatic. Recommended: Manual on workstations.",
            Tags = ["virtualization", "vds", "service", "startup", "performance"],
            RegistryKeys = [@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\vds"],
            ApplyOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\vds", "Start", 3),
            ],
            RemoveOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\vds", "Start", 2),
            ],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables the Remote Desktop Virtualization (RDV) policy. Prevents RD session host from using virtualization layer. Default: Enabled. Recommended: Disabled for non-RDS systems.",
            Tags = ["virtualization", "rdv", "rdp", "policy", "rds"],
            RegistryKeys = [@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\HyperV"],
            ApplyOps =
            [
                RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\HyperV", "DisableRemoteDesktopVirtualization", 1),
            ],
            RemoveOps =
            [
                RegOp.DeleteValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\HyperV", "DisableRemoteDesktopVirtualization"),
            ],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Sets the Hyper-V Virtual Machine Management Service (VMMS) to manual start. Frees resources if Hyper-V VMs are not regularly used. Default: Automatic. Recommended: Manual on non-VM hosts.",
        ...
        new TweakDef
        {
            ...
            RegistryKeys = [@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization"],
            ApplyOps = [RegOp.SetDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization", "EnableNestedVirtualization", 1)],
            RemoveOps = [RegOp.DeleteValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization", "EnableNestedVirtualization")],
            DetectOps = [RegOp.CheckDword(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Virtualization", "EnableNestedVirtualization", 1)],
        },
        new TweakDef
        {
