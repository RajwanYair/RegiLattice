...
internal static class Clipboard
{
    ...
    [
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = false,
            CorpSafe = true,
            Description = "Disables the Windows 10/11 Clipboard Experience feature (Win+V panel). Falls back to traditional clipboard. Default: enabled.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables clipboard cloud synchronisation across devices via Group Policy. Prevents clipboard data from leaving the device. Default: allowed.",
            Tags = ["clipboard", "cloud", "sync", "privacy"],
            RegistryKeys = [@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\System"],
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = false,
            CorpSafe = true,
            Description = "Disables clipboard roaming (syncing clipboard content to other signed-in devices). Keeps clipboard data local. Default: enabled.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = false,
            CorpSafe = true,
            Description = "Disables clipboard content suggestions and recommended actions. Prevents UI pop-ups when copying content. Default: enabled.",
        ...
        new TweakDef
        {
            ...
            NeedsAdmin = true,
            CorpSafe = true,
            Description = "Disables clipboard redirection during Remote Desktop sessions. Prevents clipboard data from crossing the RDP boundary. Default: allowed.",
