...
| Test coverage | **3,373** tests, ≥90% line | Zero skipped, zero suppressed warnings |
...
| **Test suite** | **3,373 xUnit tests** | Pester tests | None | None | None | None |
...
> undo, snapshot/restore, 5 integrated package managers, and a 3,373-test quality gate.
...
- [ ] Verify all 3,373+ tests pass on xUnit v3
...
| **Tests** | 3,373 (xUnit v2) | 3,200+ (xUnit v3) | 3,500+ | 4,000+ | 4,000+ |
...
| R4 | **xUnit v3 breaks 3,373 tests** | CI blocked for days | Medium | Branch migration; one project at a time; hold FsCheck.Xunit v3 until verified |
