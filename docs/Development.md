...
> Last updated: 2026-03-18 · v3.5.0
...
├── tests/RegiLattice.Core.Tests/   # 738 xUnit tests
├── tests/RegiLattice.CLI.Tests/    # 103 xUnit tests
└── tests/RegiLattice.GUI.Tests/    # 131 xUnit tests
```
