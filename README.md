...
- **7,518 verified tweaks** across 127 categories — each fully reversible with apply + remove
...
- **3,239 tests** across 17+ test files — full engine, model, service, plugin, and GUI coverage (xUnit)
