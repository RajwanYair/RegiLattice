<!-- SEO / GitHub search keywords
     ...
     7275 tweaks 443 categories declarative regop engine dry-run snapshot diff
...
- **7275 verified tweaks** across 443 categories — each fully reversible with apply + remove
...
graph LR
    ...
    subgraph Tweaks["443 Categories · 7275 tweaks"]
        T1[Performance]
        T2[Privacy]
        T3[Security]
        T4[Gaming]
...
graph TD
    subgraph SRC["📁 src/"]
        CORE["📦 RegiLattice.Core<br/>TweakEngine · SnapshotManager · TweakValidator<br/>DependencyResolver · RegistrySession · CorporateGuard<br/>14 Services · Plugins<br/>438 Modules · 7275 tweaks · 443 categories"]
