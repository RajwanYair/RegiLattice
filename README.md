...
- **4975 verified tweaks** across 213 categories — each fully reversible with apply + remove
...
graph LR
    ...
    subgraph Tweaks["208 Tweak Modules"]
        T1[Performance.cs]
        T2[Privacy.cs]
        T3[Security.cs]
        T4[Gaming.cs]
...
│   │   └── Tweaks/                          # 208 module files, 4975 tweaks
│   │       ├── Accessibility.cs
│   │       ├── Performance.cs
│   │       ├── Privacy.cs
│   │       ├── ...                          # 168 more
...
> Windows 10/11 registry tweaks toolkit — 4975 tweaks, debloater, privacy hardening, performance optimizer, security hardening, group policy alternative. WinForms GUI + CLI. .NET 10, C# 13.
