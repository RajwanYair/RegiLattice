...
A comprehensive Windows registry tweak toolkit with **4 628 verified tweaks** across **178 categories**, a **declarative RegOp engine**, a **full CLI** with 25+ commands, an **interactive console menu**, and a **WinForms GUI** with **11 switchable themes**. Built on **.NET 10** for native performance on Windows 10/11.

## Download & Install

**Pre-built installer (recommended):**

👉 **[Download RegiLattice v4.8.0](https://github.com/RajwanYair/RegiLattice/releases/latest)** (MSI installer + portable EXE) from the [Releases page](https://github.com/RajwanYair/RegiLattice/releases)
...
- **4 628 verified tweaks** across 178 categories — each fully reversible with apply + remove
...
- **2 661 tests** across 17+ test files — full engine, model, service, plugin, and GUI coverage (xUnit)
...
## Tweak Categories (178)

178 categories spanning privacy, performance, security, accessibility, gaming, networking, browser hardening, developer tools, and more. Each tweak is fully reversible with apply/remove/detect operations.
