<!-- SEO / GitHub search keywords
     ...
     5525 tweaks 268 categories declarative regop engine dry-run snapshot diff
...
- **5525 verified tweaks** across 268 categories — each fully reversible with apply + remove
