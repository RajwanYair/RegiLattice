<!-- SEO / GitHub search keywords
     ...
     5475 tweaks 263 categories declarative regop engine dry-run snapshot diff
...
- **5475 verified tweaks** across 263 categories — each fully reversible with apply + remove
