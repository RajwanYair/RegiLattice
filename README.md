<!-- SEO / GitHub search keywords
     ...
     9190 tweaks 637 categories declarative regop engine dry-run snapshot diff
...
- **9,190 verified tweaks** across 637 categories — each fully reversible with apply + remove
...
graph LR
    ...
    subgraph Tweaks["637 Categories · 9,190 tweaks"]
        T1[Performance]
        T2[Privacy]
        T3[Security]
        T4[Gaming]
...
637 categories spanning privacy, performance, security, accessibility, gaming, networking, browser hardening, developer tools, identity, biometrics, compliance, voice access, app consent, and more. Each tweak is fully reversible with apply/remove/detect operations.
...
graph TD
    subgraph SRC["📁 src/"]
        CORE["📦 RegiLattice.Core<br/>TweakEngine · SnapshotManager · TweakValidator<br/>DependencyResolver · RegistrySession · CorporateGuard<br/>14 Services · Plugins<br/>665 Modules · 9,190 tweaks · 637 categories"]
