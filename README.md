<!-- SEO / GitHub search keywords
     ...
     5375 tweaks 253 categories declarative regop engine dry-run snapshot diff
...
- **5375 verified tweaks** across 253 categories — each fully reversible with apply + remove
