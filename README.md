...
- **4925 verified tweaks** across 208 categories — each fully reversible with apply + remove
...
graph LR
    ...
    subgraph Tweaks["203 Tweak Modules"]
        T1[Performance.cs]
        T2[Privacy.cs]
        T3[Security.cs]
        T4[Gaming.cs]
