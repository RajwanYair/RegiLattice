<!-- SEO / GitHub search keywords
     ...
     5325 tweaks 248 categories declarative regop engine dry-run snapshot diff
...
- **5325 verified tweaks** across 248 categories — each fully reversible with apply + remove
